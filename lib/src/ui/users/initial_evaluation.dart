...
class InitialEvaluationPatient extends StatefulWidget with EmptyFieldValidators{
...
class _InitialEvaluationPatientState extends State<InitialEvaluationPatient>{
  ...
  final List<String> lessiones_eye = <String>['Izquierdo','Derecho','Ambos' ];
  final List<String> patology = <String>['Seleccionar','Izquierdo','Derecho','Ambos' ];
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            'Por favor ingrese los datos de la evaluación inicial',
