...
class PatientHospitalization extends StatefulWidget with EmptyFieldValidators{

  @override
  State<PatientHospitalization> createState() => _PatientHospitalization();
}

class _PatientHospitalization extends State<PatientHospitalization>{
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            'Por favor ingrese los datos de la hospitalizaciòn',
